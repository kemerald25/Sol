import{PublicKey as t,SystemProgram as e,TransactionInstruction as r,SYSVAR_RENT_PUBKEY as n}from"@solana/web3.js";var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{};function o(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}for(var s={},a={byteLength:function(t){var e=l(t),r=e[0],n=e[1];return 3*(r+n)/4-n},toByteArray:function(t){var e,r,n=l(t),i=n[0],o=n[1],s=new f(function(t,e,r){return 3*(e+r)/4-r}(0,i,o)),a=0,u=o>0?i-4:i;for(r=0;r<u;r+=4)e=c[t.charCodeAt(r)]<<18|c[t.charCodeAt(r+1)]<<12|c[t.charCodeAt(r+2)]<<6|c[t.charCodeAt(r+3)],s[a++]=e>>16&255,s[a++]=e>>8&255,s[a++]=255&e;2===o&&(e=c[t.charCodeAt(r)]<<2|c[t.charCodeAt(r+1)]>>4,s[a++]=255&e);1===o&&(e=c[t.charCodeAt(r)]<<10|c[t.charCodeAt(r+1)]<<4|c[t.charCodeAt(r+2)]>>2,s[a++]=e>>8&255,s[a++]=255&e);return s},fromByteArray:function(t){for(var e,r=t.length,n=r%3,i=[],o=16383,s=0,a=r-n;s<a;s+=o)i.push(p(t,s,s+o>a?a:s+o));1===n?(e=t[r-1],i.push(u[e>>2]+u[e<<4&63]+"==")):2===n&&(e=(t[r-2]<<8)+t[r-1],i.push(u[e>>10]+u[e>>4&63]+u[e<<2&63]+"="));return i.join("")}},u=[],c=[],f="undefined"!=typeof Uint8Array?Uint8Array:Array,h="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",d=0;d<64;++d)u[d]=h[d],c[h.charCodeAt(d)]=d;function l(t){var e=t.length;if(e%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var r=t.indexOf("=");return-1===r&&(r=e),[r,r===e?0:4-r%4]}function p(t,e,r){for(var n,i,o=[],s=e;s<r;s+=3)n=(t[s]<<16&16711680)+(t[s+1]<<8&65280)+(255&t[s+2]),o.push(u[(i=n)>>18&63]+u[i>>12&63]+u[i>>6&63]+u[63&i]);return o.join("")}c["-".charCodeAt(0)]=62,c["_".charCodeAt(0)]=63;var y={
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */
read:function(t,e,r,n,i){var o,s,a=8*i-n-1,u=(1<<a)-1,c=u>>1,f=-7,h=r?i-1:0,d=r?-1:1,l=t[e+h];for(h+=d,o=l&(1<<-f)-1,l>>=-f,f+=a;f>0;o=256*o+t[e+h],h+=d,f-=8);for(s=o&(1<<-f)-1,o>>=-f,f+=n;f>0;s=256*s+t[e+h],h+=d,f-=8);if(0===o)o=1-c;else{if(o===u)return s?NaN:1/0*(l?-1:1);s+=Math.pow(2,n),o-=c}return(l?-1:1)*s*Math.pow(2,o-n)},write:function(t,e,r,n,i,o){var s,a,u,c=8*o-i-1,f=(1<<c)-1,h=f>>1,d=23===i?Math.pow(2,-24)-Math.pow(2,-77):0,l=n?0:o-1,p=n?1:-1,y=e<0||0===e&&1/e<0?1:0;for(e=Math.abs(e),isNaN(e)||e===1/0?(a=isNaN(e)?1:0,s=f):(s=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-s))<1&&(s--,u*=2),(e+=s+h>=1?d/u:d*Math.pow(2,1-h))*u>=2&&(s++,u/=2),s+h>=f?(a=0,s=f):s+h>=1?(a=(e*u-1)*Math.pow(2,i),s+=h):(a=e*Math.pow(2,h-1)*Math.pow(2,i),s=0));i>=8;t[r+l]=255&a,l+=p,a/=256,i-=8);for(s=s<<i|a,c+=i;c>0;t[r+l]=255&s,l+=p,s/=256,c-=8);t[r+l-p]|=128*y}};
/*!
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */const so=BigInt(0),ao=BigInt(1),uo=BigInt(2),co=BigInt(8),fo={zip215:!0};function ho(t){const e=function(t){const e=oo(t);return Fi(t,{hash:"function",a:"bigint",d:"bigint",randomBytes:"function"},{adjustScalarBytes:"function",domain:"function",uvRatio:"function",mapToCurve:"function"}),Object.freeze({...e})}(t),{Fp:r,n:n,prehash:i,hash:o,randomBytes:s,nByteLength:a,h:u}=e,c=uo<<BigInt(8*a)-ao,f=r.create,h=e.uvRatio||((t,e)=>{try{return{isValid:!0,value:r.sqrt(t*r.inv(e))}}catch(t){return{isValid:!1,value:so}}}),d=e.adjustScalarBytes||(t=>t),l=e.domain||((t,e,r)=>{if(e.length||r)throw new Error("Contexts/pre-hash are not supported");return t}),p=t=>"bigint"==typeof t&&so<t,y=(t,e)=>p(t)&&p(e)&&t<e,g=t=>t===so||y(t,c);function w(t,e){if(y(t,e))return t;throw new Error(`Expected valid scalar < ${e}, got ${typeof t} ${t}`)}function b(t){return t===so?t:w(t,n)}const m=new Map;function v(t){if(!(t instanceof E))throw new Error("ExtendedPoint expected")}class E{constructor(t,e,r,n){if(this.ex=t,this.ey=e,this.ez=r,this.et=n,!g(t))throw new Error("x required");if(!g(e))throw new Error("y required");if(!g(r))throw new Error("z required");if(!g(n))throw new Error("t required")}get x(){return this.toAffine().x}get y(){return this.toAffine().y}static fromAffine(t){if(t instanceof E)throw new Error("extended point not allowed");const{x:e,y:r}=t||{};if(!g(e)||!g(r))throw new Error("invalid affine point");return new E(e,r,ao,f(e*r))}static normalizeZ(t){const e=r.invertBatch(t.map((t=>t.ez)));return t.map(((t,r)=>t.toAffine(e[r]))).map(E.fromAffine)}_setWindowSize(t){this._WINDOW_SIZE=t,m.delete(this)}assertValidity(){const{a:t,d:r}=e;if(this.is0())throw new Error("bad point: ZERO");const{ex:n,ey:i,ez:o,et:s}=this,a=f(n*n),u=f(i*i),c=f(o*o),h=f(c*c),d=f(a*t);if(f(c*f(d+u))!==f(h+f(r*f(a*u))))throw new Error("bad point: equation left != right (1)");if(f(n*i)!==f(o*s))throw new Error("bad point: equation left != right (2)")}equals(t){v(t);const{ex:e,ey:r,ez:n}=this,{ex:i,ey:o,ez:s}=t,a=f(e*s),u=f(i*n),c=f(r*s),h=f(o*n);return a===u&&c===h}is0(){return this.equals(E.ZERO)}negate(){return new E(f(-this.ex),this.ey,this.ez,f(-this.et))}double(){const{a:t}=e,{ex:r,ey:n,ez:i}=this,o=f(r*r),s=f(n*n),a=f(uo*f(i*i)),u=f(t*o),c=r+n,h=f(f(c*c)-o-s),d=u+s,l=d-a,p=u-s,y=f(h*l),g=f(d*p),w=f(h*p),b=f(l*d);return new E(y,g,b,w)}add(t){v(t);const{a:r,d:n}=e,{ex:i,ey:o,ez:s,et:a}=this,{ex:u,ey:c,ez:h,et:d}=t;if(r===BigInt(-1)){const t=f((o-i)*(c+u)),e=f((o+i)*(c-u)),r=f(e-t);if(r===so)return this.double();const n=f(s*uo*d),l=f(a*uo*h),p=l+n,y=e+t,g=l-n,w=f(p*r),b=f(y*g),m=f(p*g),v=f(r*y);return new E(w,b,v,m)}const l=f(i*u),p=f(o*c),y=f(a*n*d),g=f(s*h),w=f((i+o)*(u+c)-l-p),b=g-y,m=g+y,A=f(p-r*l),B=f(w*b),I=f(m*A),S=f(w*A),x=f(b*m);return new E(B,I,x,S)}subtract(t){return this.add(t.negate())}wNAF(t){return I.wNAFCached(this,m,t,E.normalizeZ)}multiply(t){const{p:e,f:r}=this.wNAF(w(t,n));return E.normalizeZ([e,r])[0]}multiplyUnsafe(t){let e=b(t);return e===so?B:this.equals(B)||e===ao?this:this.equals(A)?this.wNAF(e).p:I.unsafeLadder(this,e)}isSmallOrder(){return this.multiplyUnsafe(u).is0()}isTorsionFree(){return I.unsafeLadder(this,n).is0()}toAffine(t){const{ex:e,ey:n,ez:i}=this,o=this.is0();null==t&&(t=o?co:r.inv(i));const s=f(e*t),a=f(n*t),u=f(i*t);if(o)return{x:so,y:ao};if(u!==ao)throw new Error("invZ was invalid");return{x:s,y:a}}clearCofactor(){const{h:t}=e;return t===ao?this:this.multiplyUnsafe(t)}static fromHex(t,n=!1){const{d:i,a:o}=e,s=r.BYTES,a=(t=Wi("pointHex",t,s)).slice(),u=t[s-1];a[s-1]=-129&u;const d=Oi(a);d===so||w(d,n?c:r.ORDER);const l=f(d*d),p=f(l-ao),y=f(i*l-o);let{isValid:g,value:b}=h(p,y);if(!g)throw new Error("Point.fromHex: invalid y coordinate");const m=(b&ao)===ao,v=0!=(128&u);if(!n&&b===so&&v)throw new Error("Point.fromHex: x=0 and x_0=1");return v!==m&&(b=f(-b)),E.fromAffine({x:b,y:d})}static fromPrivateKey(t){return R(t).point}toRawBytes(){const{x:t,y:e}=this.toAffine(),n=Di(e,r.BYTES);return n[n.length-1]|=t&ao?128:0,n}toHex(){return Ui(this.toRawBytes())}}E.BASE=new E(e.Gx,e.Gy,ao,f(e.Gx*e.Gy)),E.ZERO=new E(so,ao,ao,so);const{BASE:A,ZERO:B}=E,I=function(t,e){const r=(t,e)=>{const r=e.negate();return t?r:e},n=t=>({windows:Math.ceil(e/t)+1,windowSize:2**(t-1)});return{constTimeNegate:r,unsafeLadder(e,r){let n=t.ZERO,i=e;for(;r>no;)r&io&&(n=n.add(i)),i=i.double(),r>>=io;return n},precomputeWindow(t,e){const{windows:r,windowSize:i}=n(e),o=[];let s=t,a=s;for(let t=0;t<r;t++){a=s,o.push(a);for(let t=1;t<i;t++)a=a.add(s),o.push(a);s=a.double()}return o},wNAF(e,i,o){const{windows:s,windowSize:a}=n(e);let u=t.ZERO,c=t.BASE;const f=BigInt(2**e-1),h=2**e,d=BigInt(e);for(let t=0;t<s;t++){const e=t*a;let n=Number(o&f);o>>=d,n>a&&(n-=h,o+=io);const s=e,l=e+Math.abs(n)-1,p=t%2!=0,y=n<0;0===n?c=c.add(r(p,i[s])):u=u.add(r(y,i[l]))}return{p:u,f:c}},wNAFCached(t,e,r,n){const i=t._WINDOW_SIZE||1;let o=e.get(t);return o||(o=this.precomputeWindow(t,i),1!==i&&e.set(t,n(o))),this.wNAF(i,o,r)}}}(E,8*a);function S(t){return $i(t,n)}function x(t){return S(Oi(t))}function R(t){const e=a;t=Wi("private key",t,e);const r=Wi("hashed private key",o(t),2*e),n=d(r.slice(0,e)),i=r.slice(e,2*e),s=x(n),u=A.multiply(s),c=u.toRawBytes();return{head:n,prefix:i,scalar:s,point:u,pointBytes:c}}function k(t=new Uint8Array,...e){const r=Mi(...e);return x(o(l(r,Wi("context",t),!!i)))}const _=fo;A._setWindowSize(8);return{CURVE:e,getPublicKey:function(t){return R(t).pointBytes},sign:function(t,e,n={}){t=Wi("message",t),i&&(t=i(t));const{prefix:o,scalar:s,pointBytes:u}=R(e),c=k(n.context,o,t),f=A.multiply(c).toRawBytes(),h=S(c+k(n.context,f,u,t)*s);return b(h),Wi("result",Mi(f,Di(h,r.BYTES)),2*a)},verify:function(t,e,n,o=_){const{context:s,zip215:a}=o,u=r.BYTES;t=Wi("signature",t,2*u),e=Wi("message",e),i&&(e=i(e));const c=Oi(t.slice(u,2*u));let f,h,d;try{f=E.fromHex(n,a),h=E.fromHex(t.slice(0,u),a),d=A.multiplyUnsafe(c)}catch(t){return!1}if(!a&&f.isSmallOrder())return!1;const l=k(s,h.toRawBytes(),f.toRawBytes(),e);return h.add(f.multiplyUnsafe(l)).subtract(d).clearCofactor().equals(E.ZERO)},ExtendedPoint:E,utils:{getExtendedPublicKey:R,randomPrivateKey:()=>s(r.BYTES),precompute:(t=8,e=E.BASE)=>(e._setWindowSize(t),e.multiply(BigInt(3)),e)}}}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */const lo=BigInt("57896044618658097711785492504343953926634992332820282019728792003956564819949"),po=BigInt("19681161376707505956807079304988542015446066515923890162744021073123829784752");BigInt(0);const yo=BigInt(1),go=BigInt(2),wo=BigInt(5),bo=BigInt(10),mo=BigInt(20),vo=BigInt(40),Eo=BigInt(80);const Ao=function(t,e,r=!1,n={}){if(t<=Vi)throw new Error(`Expected Field ORDER > 0, got ${t}`);const{nBitLength:i,nByteLength:o}=ro(t,e);if(o>2048)throw new Error("Field lengths over 2048 bytes are not supported");const s=to(t),a=Object.freeze({ORDER:t,BITS:i,BYTES:o,MASK:zi(i),ZERO:Vi,ONE:Hi,create:e=>$i(e,t),isValid:e=>{if("bigint"!=typeof e)throw new Error("Invalid field element: expected bigint, got "+typeof e);return Vi<=e&&e<t},is0:t=>t===Vi,isOdd:t=>(t&Hi)===Hi,neg:e=>$i(-e,t),eql:(t,e)=>t===e,sqr:e=>$i(e*e,t),add:(e,r)=>$i(e+r,t),sub:(e,r)=>$i(e-r,t),mul:(e,r)=>$i(e*r,t),pow:(t,e)=>function(t,e,r){if(r<Vi)throw new Error("Expected power > 0");if(r===Vi)return t.ONE;if(r===Hi)return e;let n=t.ONE,i=e;for(;r>Vi;)r&Hi&&(n=t.mul(n,i)),i=t.sqr(i),r>>=Hi;return n}(a,t,e),div:(e,r)=>$i(e*Ji(r,t),t),sqrN:t=>t*t,addN:(t,e)=>t+e,subN:(t,e)=>t-e,mulN:(t,e)=>t*e,inv:e=>Ji(e,t),sqrt:n.sqrt||(t=>s(a,t)),invertBatch:t=>function(t,e){const r=new Array(e.length),n=e.reduce(((e,n,i)=>t.is0(n)?e:(r[i]=e,t.mul(e,n))),t.ONE),i=t.inv(n);return e.reduceRight(((e,n,i)=>t.is0(n)?e:(r[i]=t.mul(e,r[i]),t.mul(e,n))),i),r}(a,t),cmov:(t,e,r)=>r?e:t,toBytes:t=>r?Di(t,o):Ni(t,o),fromBytes:t=>{if(t.length!==o)throw new Error(`Fp.fromBytes: expected ${o}, got ${t.length}`);return r?Oi(t):function(t){return Li(Ui(t))}(t)}});return Object.freeze(a)}(lo,void 0,!0),Bo={a:BigInt(-1),d:BigInt("37095705934669439343138083508754565189542113879843219016388785533085940283555"),Fp:Ao,n:BigInt("7237005577332262213973186563042994240857116359379907606001950938285454250989"),h:BigInt(8),Gx:BigInt("15112221349535400772501151409588531511454012693041857206046113283949847762202"),Gy:BigInt("46316835694926478169428394003475163141307993866256225615783033603165251855960"),hash:Si,randomBytes:function(t=32){if(Ee&&"function"==typeof Ee.getRandomValues)return Ee.getRandomValues(new Uint8Array(t));throw new Error("crypto.getRandomValues must be defined")},adjustScalarBytes:function(t){return t[0]&=248,t[31]&=127,t[31]|=64,t},uvRatio:function(t,e){const r=lo,n=$i(e*e*e,r),i=function(t){const e=lo,r=t*t%e*t%e,n=Qi(r,go,e)*r%e,i=Qi(n,yo,e)*t%e,o=Qi(i,wo,e)*i%e,s=Qi(o,bo,e)*o%e,a=Qi(s,mo,e)*s%e,u=Qi(a,vo,e)*a%e,c=Qi(u,Eo,e)*u%e,f=Qi(c,Eo,e)*u%e,h=Qi(f,bo,e)*o%e;return{pow_p_5_8:Qi(h,go,e)*t%e,b2:r}}(t*$i(n*n*e,r)).pow_p_5_8;let o=$i(t*n*i,r);const s=$i(e*o*o,r),a=o,u=$i(o*po,r),c=s===t,f=s===$i(-t,r),h=s===$i(-t*po,r);return c&&(o=a),(f||h)&&(o=u),($i(o,r)&Hi)===Hi&&(o=$i(-o,r)),{isValid:c||f,value:o}}},Io=ho(Bo);const So=(Ao.ORDER+BigInt(3))/BigInt(8);
/*! scure-base - MIT License (c) 2022 Paul Miller (paulmillr.com) */
function xo(t){if(!Number.isSafeInteger(t))throw new Error(`Wrong integer: ${t}`)}function Ro(...t){const e=t=>t,r=(t,e)=>r=>t(e(r));return{encode:t.map((t=>t.encode)).reduceRight(r,e),decode:t.map((t=>t.decode)).reduce(r,e)}}function ko(t){return{encode:e=>{if(!Array.isArray(e)||e.length&&"number"!=typeof e[0])throw new Error("alphabet.encode input should be an array of numbers");return e.map((e=>{if(xo(e),e<0||e>=t.length)throw new Error(`Digit index outside alphabet: ${e} (alphabet: ${t.length})`);return t[e]}))},decode:e=>{if(!Array.isArray(e)||e.length&&"string"!=typeof e[0])throw new Error("alphabet.decode input should be array of strings");return e.map((e=>{if("string"!=typeof e)throw new Error(`alphabet.decode: not string element=${e}`);const r=t.indexOf(e);if(-1===r)throw new Error(`Unknown letter: "${e}". Allowed: ${t}`);return r}))}}}function _o(t=""){if("string"!=typeof t)throw new Error("join separator should be string");return{encode:e=>{if(!Array.isArray(e)||e.length&&"string"!=typeof e[0])throw new Error("join.encode input should be array of strings");for(let t of e)if("string"!=typeof t)throw new Error(`join.encode: non-string input=${t}`);return e.join(t)},decode:e=>{if("string"!=typeof e)throw new Error("join.decode input should be string");return e.split(t)}}}function Uo(t,e="="){if(xo(t),"string"!=typeof e)throw new Error("padding chr should be string");return{encode(r){if(!Array.isArray(r)||r.length&&"string"!=typeof r[0])throw new Error("padding.encode input should be array of strings");for(let t of r)if("string"!=typeof t)throw new Error(`padding.encode: non-string input=${t}`);for(;r.length*t%8;)r.push(e);return r},decode(r){if(!Array.isArray(r)||r.length&&"string"!=typeof r[0])throw new Error("padding.encode input should be array of strings");for(let t of r)if("string"!=typeof t)throw new Error(`padding.decode: non-string input=${t}`);let n=r.length;if(n*t%8)throw new Error("Invalid padding: string should have whole number of bytes");for(;n>0&&r[n-1]===e;n--)if(!((n-1)*t%8))throw new Error("Invalid padding: string has too much padding");return r.slice(0,n)}}}function Lo(t){if("function"!=typeof t)throw new Error("normalize fn should be function");return{encode:t=>t,decode:e=>t(e)}}Ao.pow(go,So),Ao.sqrt(Ao.neg(Ao.ONE)),Ao.ORDER,BigInt(5),BigInt(8),BigInt(486662),function(t,e){if(!t.isOdd)throw new Error("Field doesn't have isOdd");const r=t.sqrt(e);t.isOdd(r)&&t.neg(r)}(Ao,Ao.neg(BigInt(486664))),BigInt("25063068953384623474111414158702152701244531502492656460079210482610430750235"),BigInt("54469307008909316920995813868745141605393597292927456921205312896311721017578"),BigInt("1159843021668779879193775521855586647937357759715417654439879720876111806838"),BigInt("40440834346308536858101042469323190826248399146238708352240133220865137265952"),BigInt("0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");const Po=(t,e)=>e?Po(e,t%e):t,To=(t,e)=>t+(e-Po(t,e));function Co(t,e,r,n){if(!Array.isArray(t))throw new Error("convertRadix2: data should be array");if(e<=0||e>32)throw new Error(`convertRadix2: wrong from=${e}`);if(r<=0||r>32)throw new Error(`convertRadix2: wrong to=${r}`);if(To(e,r)>32)throw new Error(`convertRadix2: carry overflow from=${e} to=${r} carryBits=${To(e,r)}`);let i=0,o=0;const s=2**r-1,a=[];for(const n of t){if(xo(n),n>=2**e)throw new Error(`convertRadix2: invalid data word=${n} from=${e}`);if(i=i<<e|n,o+e>32)throw new Error(`convertRadix2: carry overflow pos=${o} from=${e}`);for(o+=e;o>=r;o-=r)a.push((i>>o-r&s)>>>0);i&=2**o-1}if(i=i<<r-o&s,!n&&o>=e)throw new Error("Excess padding");if(!n&&i)throw new Error(`Non-zero padding: ${i}`);return n&&o>0&&a.push(i>>>0),a}function Oo(t,e=!1){if(xo(t),t<=0||t>32)throw new Error("radix2: bits should be in (0..32]");if(To(8,t)>32||To(t,8)>32)throw new Error("radix2: carry overflow");return{encode:r=>{if(!function(t){return t instanceof Uint8Array||null!=t&&"object"==typeof t&&"Uint8Array"===t.constructor.name}(r))throw new Error("radix2.encode input should be Uint8Array");return Co(Array.from(r),8,t,!e)},decode:r=>{if(!Array.isArray(r)||r.length&&"number"!=typeof r[0])throw new Error("radix2.decode input should be array of numbers");return Uint8Array.from(Co(r,t,8,e))}}}function No(t){if("function"!=typeof t)throw new Error("unsafeWrapper fn should be function");return function(...e){try{return t.apply(null,e)}catch(t){}}}Oo(4),ko("0123456789ABCDEF"),_o(""),Oo(5),ko("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"),Uo(5),_o(""),Oo(5),ko("0123456789ABCDEFGHIJKLMNOPQRSTUV"),Uo(5),_o(""),Oo(5),ko("0123456789ABCDEFGHJKMNPQRSTVWXYZ"),_o(""),Lo((t=>t.toUpperCase().replace(/O/g,"0").replace(/[IL]/g,"1"))),Oo(6),ko("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"),Uo(6),_o(""),Oo(6),ko("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"),Uo(6),_o(""),Oo(6),ko("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"),_o("");const Do=Ro(ko("qpzry9x8gf2tvdw0s3jn54khce6mua7l"),_o("")),Wo=[996825010,642813549,513874426,1027748829,705979059];function Mo(t){const e=t>>25;let r=(33554431&t)<<5;for(let t=0;t<Wo.length;t++)1==(e>>t&1)&&(r^=Wo[t]);return r}function zo(t,e,r=1){const n=t.length;let i=1;for(let e=0;e<n;e++){const r=t.charCodeAt(e);if(r<33||r>126)throw new Error(`Invalid prefix (${t})`);i=Mo(i)^r>>5}i=Mo(i);for(let e=0;e<n;e++)i=Mo(i)^31&t.charCodeAt(e);for(let t of e)i=Mo(i)^t;for(let t=0;t<6;t++)i=Mo(i);return i^=r,Do.encode(Co([i%2**30],30,5,!1))}function jo(t){const e="bech32"===t?1:734539939,r=Oo(5),n=r.decode,i=r.encode,o=No(n);function s(t,r=90){if("string"!=typeof t)throw new Error("bech32.decode input should be string, not "+typeof t);if(t.length<8||!1!==r&&t.length>r)throw new TypeError(`Wrong string length: ${t.length} (${t}). Expected (8..${r})`);const n=t.toLowerCase();if(t!==n&&t!==t.toUpperCase())throw new Error("String must be lowercase or uppercase");const i=(t=n).lastIndexOf("1");if(0===i||-1===i)throw new Error('Letter "1" must be present between prefix and data only');const o=t.slice(0,i),s=t.slice(i+1);if(s.length<6)throw new Error("Data must be at least 6 characters long");const a=Do.decode(s).slice(0,-6),u=zo(o,a,e);if(!s.endsWith(u))throw new Error(`Invalid checksum in ${t}: expected "${u}"`);return{prefix:o,words:a}}return{encode:function(t,r,n=90){if("string"!=typeof t)throw new Error("bech32.encode prefix should be string, not "+typeof t);if(!Array.isArray(r)||r.length&&"number"!=typeof r[0])throw new Error("bech32.encode words should be array of numbers, not "+typeof r);const i=t.length+7+r.length;if(!1!==n&&i>n)throw new TypeError(`Length ${i} exceeds limit ${n}`);const o=t.toLowerCase(),s=zo(o,r,e);return`${o}1${Do.encode(r)}${s}`},decode:s,decodeToBytes:function(t){const{prefix:e,words:r}=s(t,!1);return{prefix:e,words:r,bytes:n(r)}},decodeUnsafe:No(s),fromWords:n,fromWordsUnsafe:o,toWords:i}}const Fo=jo("bech32");Oo(4),ko("0123456789abcdef"),_o(""),Lo((t=>{if("string"!=typeof t||t.length%2)throw new TypeError(`hex.decode: expected string, got ${typeof t} with length ${t.length}`);return t.toLowerCase()}));const Vo=(t,e,r)=>Io.verify(e,t,r.toBytes()),Ho=(t,e)=>{const{pubkey:r}=Vn(e+"."+t,Vr.V1);return r};async function Go(t,e,r,n){const i=Ho(e,r);let{registry:o}=await be.retrieve(t,i);if(!o.data)throw new Pt(Lt.NoRecordData);if(n)return ps(o,r,i);const s=Fr.get(r);return o.data=o.data.slice(0,s),o}async function qo(t,e,r,n){const i=r.map((t=>Ho(e,t))),o=await be.retrieveBatch(t,i);return n?o.map(((t,n)=>{if(t)return ps(t,r[n],Ho(e,r[n]))})):o}const Xo=async(t,e)=>await Go(t,e,jr.IPFS,!0),Yo=async(t,e)=>await Go(t,e,jr.ARWV,!0),Zo=async(t,e)=>await Go(t,e,jr.ETH,!0),$o=async(t,e)=>await Go(t,e,jr.BTC,!0),Ko=async(t,e)=>await Go(t,e,jr.LTC,!0),Qo=async(t,e)=>await Go(t,e,jr.DOGE,!0),Jo=async(t,e)=>await Go(t,e,jr.Email,!0),ts=async(t,e)=>await Go(t,e,jr.Url,!0),es=async(t,e)=>await Go(t,e,jr.Discord,!0),rs=async(t,e)=>await Go(t,e,jr.Github,!0),ns=async(t,e)=>await Go(t,e,jr.Reddit,!0),is=async(t,e)=>await Go(t,e,jr.Twitter,!0),os=async(t,e)=>await Go(t,e,jr.Telegram,!0),ss=async(t,e)=>await Go(t,e,jr.Pic,!0),as=async(t,e)=>await Go(t,e,jr.SHDW,!0),us=async(t,e)=>await Go(t,e,jr.SOL),cs=async(t,e)=>await Go(t,e,jr.POINT,!0),fs=async(t,e)=>await Go(t,e,jr.BSC,!0),hs=async(t,e)=>await Go(t,e,jr.Injective,!0),ds=async(t,e)=>await Go(t,e,jr.Backpack,!0),ls=async(t,e)=>await Go(t,e,jr.Background,!0),ps=(e,r,n)=>{const i=null==e?void 0:e.data;if(!i)return;if(0===i.compare(s.Buffer.alloc(i.length)))return;const o=Fr.get(r),a=(t=>{const e=Array.from(t);return e.length-1-e.reverse().findIndex((t=>0!==t))+1})(i);if(!o){const t=i.slice(0,a).toString("utf-8");return r===jr.CNAME||r===jr.TXT?li(t):t}if(r===jr.SOL){const t=new TextEncoder,r=s.Buffer.concat([i.slice(0,32),n.toBuffer()]),o=t.encode(r.toString("hex"));if(Vo(o,i.slice(32,96),e.owner))return ri.encode(i.slice(0,32))}if(o&&a!==o){const t=i.slice(0,a).toString("utf-8");if(r===jr.Injective){const e=Fo.decodeToBytes(t);if("inj"===e.prefix&&20===e.bytes.length)return t}else if(r===jr.BSC||r===jr.ETH){const e=t.slice(0,2),r=t.slice(2);if("0x"===e&&20===s.Buffer.from(r,"hex").length)return t}else if((r===jr.A||r===jr.AAAA)&&ii.isValid(t))return t;throw new Pt(Lt.InvalidRecordData)}if(r===jr.ETH||r===jr.BSC)return"0x"+i.slice(0,o).toString("hex");if(r===jr.Injective)return Fo.encode("inj",Fo.toWords(i.slice(0,o)));if(r===jr.A||r===jr.AAAA)return ii.fromByteArray([...i.slice(0,o)]).toString();if(r===jr.Background)return new t(i.slice(0,o)).toString();throw new Pt(Lt.InvalidRecordData)},ys=(e,r)=>{if(!Fr.get(r))return r!==jr.CNAME&&r!==jr.TXT||(e=pi(e)),s.Buffer.from(e,"utf-8");if(r===jr.SOL)throw new Pt(Lt.UnsupportedRecord,"Use `serializeSolRecord` for SOL record");if(r===jr.ETH||r===jr.BSC)return Zn("0x"===e.slice(0,2),Lt.InvalidEvmAddress),s.Buffer.from(e.slice(2),"hex");if(r===jr.Injective){const t=Fo.decodeToBytes(e);return Zn("inj"===t.prefix,Lt.InvalidInjectiveAddress),Zn(20===t.bytes.length,Lt.InvalidInjectiveAddress),s.Buffer.from(t.bytes)}if(r===jr.A){const t=ii.parse(e).toByteArray();return Zn(4===t.length,Lt.InvalidARecord),s.Buffer.from(t)}if(r===jr.AAAA){const t=ii.parse(e).toByteArray();return Zn(16===t.length,Lt.InvalidAAAARecord),s.Buffer.from(t)}if(r===jr.Background)return new t(e).toBuffer();throw new Pt(Lt.InvalidRecordInput)},gs=(t,e,r,n)=>{const i=s.Buffer.concat([t.toBuffer(),e.toBuffer()]),o=(new TextEncoder).encode(i.toString("hex")),a=Vo(o,n,r);return Zn(a,Lt.InvalidSignature),s.Buffer.concat([t.toBuffer(),n])},ws=new Map([[jr.Url,new t("ExXjtfdQe8JacoqP9Z535WzQKjF4CzW1TTRKRgpxvya3")],[jr.CNAME,new t("ExXjtfdQe8JacoqP9Z535WzQKjF4CzW1TTRKRgpxvya3")]]),bs=new Set([jr.ETH,jr.Injective,jr.BSC,jr.BASE]),ms=new Set([jr.ETH,jr.BSC,jr.BASE]),vs=async(t,e,r,n)=>{var i;const o=Ss(r,e),s=await zr.retrieve(t,o),a=s.getRoAId(),u=bs.has(e)?Nr.Ethereum:Nr.Solana;if(!(n=null!=n?n:null===(i=ws.get(e))||void 0===i?void 0:i.toBuffer()))throw new Pt(Lt.MissingVerifier);return 0===n.compare(a)&&s.header.rightOfAssociationValidation===u},Es=new Set([jr.IPFS,jr.ARWV,jr.LTC,jr.DOGE,jr.Email,jr.Url,jr.Discord,jr.Github,jr.Reddit,jr.Twitter,jr.Telegram,jr.Pic,jr.SHDW,jr.POINT,jr.Backpack,jr.TXT,jr.CNAME,jr.BTC]),As=new Set([jr.ETH,jr.Injective,jr.SOL]),Bs=(e,r)=>{if(Es.has(r)){const t=e.toString("utf-8");return r===jr.CNAME||r===jr.TXT?li(t):t}if(r===jr.SOL)return new t(e).toBase58();if(ms.has(r))return"0x"+e.toString("hex");if(r===jr.Injective)return Fo.encode("inj",Fo.toWords(e));if(r===jr.A||r===jr.AAAA)return ii.fromByteArray([...e]).toString();throw new Pt(Lt.InvalidARecord)},Is=(e,r)=>{if(Es.has(r))return r!==jr.CNAME&&r!==jr.TXT||(e=pi(e)),Buffer.from(e,"utf-8");if(r===jr.SOL)return new t(e).toBuffer();if(ms.has(r))return Zn("0x"===e.slice(0,2),Lt.InvalidEvmAddress),Buffer.from(e.slice(2),"hex");if(r===jr.Injective){const t=Fo.decodeToBytes(e);return Zn("inj"===t.prefix,Lt.InvalidInjectiveAddress),Zn(20===t.bytes.length,Lt.InvalidInjectiveAddress),Buffer.from(t.bytes)}if(r===jr.A){const t=ii.parse(e).toByteArray();return Zn(4===t.length,Lt.InvalidARecord),Buffer.from(t)}if(r===jr.AAAA){const t=ii.parse(e).toByteArray();return Zn(16===t.length,Lt.InvalidAAAARecord),Buffer.from(t)}throw new Pt(Lt.InvalidARecord)},Ss=(t,e)=>{const{pubkey:r}=Vn(t),n=Dn("".concat(e));return Wn(n,Or,r)};async function xs(t,e,r,n={}){const i=Ss(e,r),o=await zr.retrieve(t,i);return n.deserialize?{retrievedRecord:o,deserializedContent:Bs(o.getContent(),r)}:{retrievedRecord:o}}async function Rs(t,e,r,n={}){const i=r.map((t=>Ss(e,t))),o=await zr.retrieveBatch(t,i);return n.deserialize?o.map(((t,e)=>{if(t)return{retrievedRecord:t,record:r[e],deserializedContent:Bs(t.getContent(),r[e])}})):o.map(((t,e)=>{if(t)return{retrievedRecord:t,record:r[e]}}))}const ks=new t("85iDfUvr3HJyLM2zcq5BXSiDvUWfw6cSE1FfNBo8Ap29");class _s{constructor(e){this.tag=e.tag,this.nameAccount=new t(e.nameAccount)}static deserialize(t){return new _s(Zt(this.schema,t))}static async retrieve(t,e){const r=await t.getAccountInfo(e);if(!r||!r.data)throw new Pt(Lt.FavouriteDomainNotFound);return this.deserialize(r.data)}static async getKey(e,r){return await t.findProgramAddress([s.Buffer.from("favourite_domain"),r.toBuffer()],e)}static getKeySync(e,r){return t.findProgramAddressSync([s.Buffer.from("favourite_domain"),r.toBuffer()],e)}}_s.schema={struct:{tag:"u8",nameAccount:{array:{type:"u8",len:32}}}};const Us=async(e,r)=>{const[n]=_s.getKeySync(ks,new t(r)),i=await _s.retrieve(e,n),o=await Mn(e,i.nameAccount),{registry:s,nftOwner:a}=await be.retrieve(e,i.nameAccount),u=a||s.owner;return{domain:i.nameAccount,reverse:o,stale:!r.equals(u)}},Ls=async(e,r)=>{const n=[],i=r.map((t=>_s.getKeySync(ks,t)[0])),o=(await e.getMultipleAccountsInfo(i)).map((e=>(null==e?void 0:e.data)?_s.deserialize(null==e?void 0:e.data).nameAccount:t.default)),s=o.map((t=>Yn(t))),a=o.map(((t,e)=>_t(fe(t),r[e],!0))),[u,c,f]=await Promise.all([e.getMultipleAccountsInfo(o),e.getMultipleAccountsInfo(s),e.getMultipleAccountsInfo(a)]);for(let e=0;e<r.length;e++){const i=u[e],o=c[e],s=f[e];if(!i||!o){n.push(void 0);continue}if(new t(null==i?void 0:i.data.slice(32,64)).equals(r[e])){n.push(Qn(null==o?void 0:o.data.slice(96)));continue}if(!s){n.push(void 0);continue}const a=It.decode(s.data);1!==Number(a.amount)?n.push(void 0):n.push(Qn(null==o?void 0:o.data.slice(96)))}return n};async function Ps(t,r,n,i,o,s,a,u){const c=Dn(r),f=Wn(c,a,u),h=s||await t.getMinimumBalanceForRentExemption(n);let d;if(u){const{registry:e}=await sr(t,u);d=e.owner}return $t(De,e.programId,f,o,i,c,new Ct(h),new Tt(n),a,u,d)}async function Ts(t,e,r,n,i,o){const s=Dn(e),a=Wn(s,i,o);let u;u=i||(await be.retrieve(t,a)).registry.owner;return Kt(De,a,new Tt(r),n,u)}async function Cs(t,e,r,n,i,o){const s=Dn(e),a=Wn(s,n,i);let u;u=n||(await be.retrieve(t,a)).registry.owner;return Qt(De,a,r,u,n,i,o)}async function Os(t,e,r,n,i){const o=Dn(e),s=Wn(o,n,i);let a;a=n||(await be.retrieve(t,s)).registry.owner;return Jt(De,s,r,a)}const Ns=async(r,i,o,s,a,u=Ye,c)=>{if(i.includes(".")||i.trim().toLowerCase()!==i)throw new Pt(Lt.InvalidDomain);const[f]=t.findProgramAddressSync([ze.toBuffer()],ze),h=Dn(i),d=Wn(h,void 0,Me),l=Dn(d.toBase58()),p=Wn(l,f),[y]=t.findProgramAddressSync([d.toBuffer()],ze),w=Ze.findIndex((t=>null==c?void 0:c.equals(t)));let b;const m=[];if(-1!==w&&c){b=_t(u,c,!0);const t=await r.getAccountInfo(b);if(!(null==t?void 0:t.data)){const t=Ut(s,b,c,u);m.push(t)}}const v=_t(u,tr,!0),E=Ke.get(u.toBase58());if(!E)throw new Pt(Lt.PythFeedNotFound);const A=new re({name:i,space:o,referrerIdxOpt:-1!=w?w:null}).getInstruction(ze,De,Me,d,p,e.programId,f,s,a,Qe,new t(E.product),new t(E.price),v,g,n,y,b);return m.push(A),[[],m]},Ds=async(r,i,o,s,a,u=Ye,c)=>{if(i.includes(".")||i.trim().toLowerCase()!==i)throw new Pt(Lt.InvalidDomain);const[f]=t.findProgramAddressSync([ze.toBuffer()],ze),h=Dn(i),d=Wn(h,void 0,Me),l=Dn(d.toBase58()),p=Wn(l,f),[y]=t.findProgramAddressSync([d.toBuffer()],ze),w=Ze.findIndex((t=>null==c?void 0:c.equals(t)));let b;const m=[];if(-1!==w&&c){b=_t(u,c,!0);const t=await r.getAccountInfo(b);if(!(null==t?void 0:t.data)){const t=Ut(s,b,c,u);m.push(t)}}const v=_t(u,tr,!0),E=or.get(u.toBase58());if(!E)throw new Pt(Lt.PythFeedNotFound);const[A]=Jn(0,E),B=new ae({name:i,space:o,referrerIdxOpt:-1!=w?w:null}).getInstruction(ze,De,Me,d,p,e.programId,f,s,s,s,a,A,v,g,n,y,b);return m.push(B),m},Ws=async(r,i,o,s,a)=>{let[u]=await t.findProgramAddress([ze.toBuffer()],ze),c=Dn(r.toBase58()),f=Wn(c,u,s);return[[],[new ee({name:i}).getInstruction(ze,De,Me,f,e.programId,u,o,n,s,a)]]},Ms=async(t,e,r,n=2e3,i)=>{const o=[],s=e.split(".")[0];if(!s)throw new Pt(Lt.InvalidSubdomain);const{parent:a,pubkey:u}=Vn(e),c=await t.getMinimumBalanceForRentExemption(n+be.HEADER_LEN),f=await Ps(t,"\0".concat(s),n,i||r,r,c,void 0,a);o.push(f);const h=Xn(e,!0),d=await t.getAccountInfo(h);if(!(null==d?void 0:d.data)){const[,t]=await Ws(u,"\0".concat(s),i||r,a,r);o.push(...t)}return[[],o]},zs=async(t,r,n,i,o,s)=>{Zn(n!==jr.SOL,Lt.UnsupportedRecord);const{pubkey:a,hashed:u,parent:c}=Vn(`${n}.${r}`,Vr.V1),f=ys(i,n).length,h=await t.getMinimumBalanceForRentExemption(f+be.HEADER_LEN);return $t(De,e.programId,a,o,s,u,new Ct(h),new Tt(f),void 0,c,o)},js=(t,r,n,i,o)=>{let{pubkey:s,parent:a,isSub:u}=Vn(`${r}.${t}`,Vr.V2);if(u&&(a=Vn(t).pubkey),!a)throw new Error("Invalid parent");const c=((t,r,n,i,o,s,a,u)=>new kr({record:s,content:Array.from(a)}).getInstruction(u,e.programId,o,t,r,n,i,Or))(o,s,a,i,De,"".concat(r),Is(n,r),Cr);return c},Fs=async(t,e,r,n,i,o)=>{Zn(r!==jr.SOL,Lt.UnsupportedRecord);const{pubkey:s}=Vn(`${r}.${e}`,Vr.V1),a=await t.getAccountInfo(s);Zn(!!(null==a?void 0:a.data),Lt.AccountDoesNotExist);const u=ys(n,r);if((null==a?void 0:a.data.slice(96).length)!==u.length)return[Jt(De,s,o,i),await zs(t,e,r,n,i,o)];return[Kt(De,s,new Tt(0),u,i)]},Vs=(t,r,n,i,o)=>{let{pubkey:s,parent:a,isSub:u}=Vn(`${r}.${t}`,Vr.V2);if(u&&(a=Vn(t).pubkey),!a)throw new Error("Invalid parent");const c=((t,r,n,i,o,s,a,u)=>new Lr({record:s,content:Array.from(a)}).getInstruction(u,e.programId,o,t,r,n,i,Or))(o,s,a,i,De,"".concat(r),Is(n,r),Cr);return c},Hs=(t,r,n,i)=>{let{pubkey:o,parent:s,isSub:a}=Vn(`${r}.${t}`,Vr.V2);if(a&&(s=Vn(t).pubkey),!s)throw new Error("Invalid parent");const u=((t,r,n,i,o,s)=>(new Pr).getInstruction(s,e.programId,o,t,i,r,n,Or))(i,s,n,o,De,Cr);return u},Gs=(t,r,n,i,o,s)=>{let{pubkey:a,parent:u,isSub:c}=Vn(`${n}.${r}`,Vr.V2);if(c&&(u=Vn(r).pubkey),!u)throw new Error("Invalid parent");const f=((t,r,n,i,o,s,a,u)=>new Ur({staleness:a}).getInstruction(u,e.programId,s,t,r,n,i,Or,o))(o,a,u,i,s,De,t,Cr);return f},qs=(t,r,n,i,o)=>{let{pubkey:s,parent:a,isSub:u}=Vn(`${r}.${t}`,Vr.V2);if(u&&(a=Vn(t).pubkey),!a)throw new Error("Invalid parent");const c=((t,r,n,i,o,s,a)=>new Tr({roaId:Array.from(s.toBuffer())}).getInstruction(a,e.programId,r,t,n,i,o,Or))(i,De,s,a,n,o,Cr);return c},Xs=(t,r,n,i,o,s)=>{let{pubkey:a,parent:u,isSub:c}=Vn(`${r}.${t}`,Vr.V2);if(c&&(u=Vn(t).pubkey),!u)throw new Error("Invalid parent");const f=((t,r,n,i,o,s,a,u,c)=>new _r({validation:s,signature:Array.from(a),expectedPubkey:Array.from(u)}).getInstruction(c,e.programId,o,t,r,n,i,Or))(i,a,u,n,De,Nr.Ethereum,o,s,Cr);return f},Ys=async(t,r,n,i,o,s)=>{const{pubkey:a,hashed:u,parent:c}=Vn(`${jr.SOL}.${r}`,Vr.V1),f=gs(n,a,i,o).length,h=await t.getMinimumBalanceForRentExemption(f+be.HEADER_LEN);return[$t(De,e.programId,a,i,s,u,new Ct(h),new Tt(f),void 0,c,i)]},Zs=async(t,e,r,n,i,o)=>{const{pubkey:s}=Vn(`${jr.SOL}.${e}`,Vr.V1),a=await t.getAccountInfo(s);if(Zn(!!(null==a?void 0:a.data),Lt.AccountDoesNotExist),96!==(null==a?void 0:a.data.length))return[Jt(De,s,o,n),await Ys(t,e,r,n,i,o)];const u=gs(r,s,n,i);return[Kt(De,s,new Tt(0),u,n)]},$s=(r,n,i)=>{const{pubkey:o}=Vn(r),[s]=t.findProgramAddressSync([o.toBuffer()],ze),[a]=t.findProgramAddressSync([o.toBuffer(),Uint8Array.from([1,1])],ze);return(new ie).getInstruction(ze,De,e.programId,o,Xn(r),a,s,Ve,n,i)},Ks=(r,i,o,s,a,u,c,f,h)=>{const[d]=t.findProgramAddressSync([o.toBuffer()],ze);return new ne({space:i,name:r}).getInstruction(ze,De,Me,o,s,e.programId,Ve,a,u,c,f,h,rr,g,n,d,nr)},Qs=async(t,e,r,n,i)=>{const{pubkey:o,isSub:s,parent:a}=Vn(e);if(!a||!s)throw new Pt(Lt.InvalidSubdomain);if(!i){const{registry:e}=await be.retrieve(t,o);i=e.owner}let u,c;n&&(u=a,c=(await be.retrieve(t,a)).registry.owner);return Qt(De,o,r,i,void 0,u,c)},Js=(t,r)=>{const[n]=_s.getKeySync(ks,r);return[(new se).getInstruction(ks,t,n,r,e.programId)]};async function ta(t,r,n,i,o){const s=Dn(r),a=Wn(s,void 0,Ge),u=await t.getMinimumBalanceForRentExemption(i+be.HEADER_LEN);let c=[$t(De,e.programId,a,n,o,s,new Ct(u),new Tt(i),void 0,Ge,He)];return c=c.concat(await fa(t,r,a,n,o)),c}async function ea(t,e,r,n){const i=Dn(t),o=Wn(i,void 0,Ge);return[Kt(De,o,new Tt(r),n,e)]}async function ra(t,e,r,n,i){const o=Dn(e),s=Wn(o,void 0,Ge);let a=[Qt(De,s,n,r,void 0)];return a.push(await Os(t,r.toString(),i,He,Ge)),a=a.concat(await fa(t,e,s,n,i)),a}async function na(t,e){const r=Dn(t),n=Wn(r,void 0,Ge),i=Dn(e.toString()),o=Wn(i,He,Ge);return[Jt(De,n,e,e),Jt(De,o,e,e)]}async function ia(t){const e=Dn(t);return Wn(e,void 0,Ge)}async function oa(t,e){const r=Dn(e),n=Wn(r,void 0,Ge),{registry:i}=await be.retrieve(t,n);return i}async function sa(e,r){const n=Dn(r.toString()),i=Wn(n,He,Ge);let o=await ca.retrieve(e,i);return[o.twitterHandle,new t(o.twitterRegistryKey)]}async function aa(e,r){const n=[{memcmp:{offset:0,bytes:Ge.toBase58()}},{memcmp:{offset:32,bytes:r.toBase58()}},{memcmp:{offset:64,bytes:He.toBase58()}}],i=await e.getProgramAccounts(De,{filters:n});for(const e of i)if(e.account.data.length>be.HEADER_LEN+32){const r=e.account.data.slice(be.HEADER_LEN),n=new ca(Zt(ca.schema,r));return[n.twitterHandle,new t(n.twitterRegistryKey)]}throw new Pt(Lt.AccountDoesNotExist)}async function ua(e,r){const n=[{memcmp:{offset:0,bytes:Ge.toBase58()}},{memcmp:{offset:32,bytes:r.toBase58()}},{memcmp:{offset:64,bytes:new t(s.Buffer.alloc(32,0)).toBase58()}}],i=await e.getProgramAccounts(De,{filters:n});if(i.length>1)throw new Pt(Lt.MultipleRegistries);return i[0].account.data.slice(be.HEADER_LEN)}class ca{constructor(t){this.twitterRegistryKey=t.twitterRegistryKey,this.twitterHandle=t.twitterHandle}static async retrieve(t,e){let r=await t.getAccountInfo(e,"processed");if(!r)throw new Pt(Lt.InvalidReverseTwitter);return new ca(Zt(ca.schema,r.data.slice(be.HEADER_LEN)))}}async function fa(t,r,n,i,o){const a=Dn(i.toString()),u=Wn(a,He,Ge);let c=Yt(ca.schema,new ca({twitterRegistryKey:n.toBytes(),twitterHandle:r}));return[$t(De,e.programId,u,i,o,a,new Ct(await t.getMinimumBalanceForRentExemption(c.length+be.HEADER_LEN)),new Tt(c.length),He,Ge,He),Kt(De,u,new Tt(0),s.Buffer.from(c),He)]}var ha;ca.schema={struct:{twitterRegistryKey:{array:{type:"u8",len:32}},twitterHandle:"string"}},function(t){t.DegenPoet1="DegenPoet#1",t.Rgb0x001="rgb0x00#1"}(ha||(ha={}));const da=async(t,e)=>{const{pubkey:r}=Vn(e),{registry:n,nftOwner:i}=await be.retrieve(t,r);if(i)return i;try{const r=await pa(t,n.owner,e);if(void 0!==r)return r;return await la(t,n.owner,e)}catch(t){if(t instanceof Error&&"FetchError"===t.name)throw t}return n.owner},la=async(e,r,n)=>{const i=Ho(n,jr.SOL),o=await us(e,n);if(!(null==o?void 0:o.data))throw new Pt(Lt.NoRecordData);const a=new TextEncoder,u=s.Buffer.concat([o.data.slice(0,32),i.toBuffer()]),c=a.encode(u.toString("hex"));if(!Vo(c,o.data.slice(32),r))throw new Pt(Lt.InvalidSignature);return new t(o.data.slice(0,32))},pa=async(e,r,n)=>{try{const i=Ss(n,jr.SOL),o=await zr.retrieve(e,i),s=o.getStalenessId(),a=o.getRoAId(),u=o.getContent();if(0===s.compare(r.toBuffer())&&o.header.stalenessValidation===Nr.Solana&&0===a.compare(u)&&o.header.rightOfAssociationValidation===Nr.Solana)return new t(u)}catch(t){if(t instanceof Error&&"FetchError"===t.name)throw t}},ya=new t("ART5dr4bDic2sQVZoFheEmUxwQq5VGSx9he7JxHcXNQD"),ga=new t("CSWvuDHXExVGEMR9kP8xYAHuNjXogeRck9Cnr312CC9g"),wa=(t,e)=>{const r=Dn(e),n=Dn(t),i=Wn(n,void 0,er);return{domainKey:i,bgKey:Wn(r,void 0,i)}},ba=t=>{switch(t){case ha.DegenPoet1:return ya;case ha.Rgb0x001:return ga;default:throw new Pt(Lt.InvalidCustomBg)}},ma=async(e,r,n)=>{const i=Ss(n,r),{registry:o,nftOwner:s}=await be.retrieve(e,Vn(n).pubkey),a=s||o.owner,u=await zr.retrieve(e,i),c=u.getStalenessId();return(null==a?void 0:a.equals(new t(c)))&&u.header.stalenessValidation===Nr.Solana},va={NAME_PROGRAM_ID:new t("namesLPneVptA9Z5rqUDD9tMTWEJwofgaYwp8cawRkX"),HASH_PREFIX:"SPL Name Service",ROOT_DOMAIN_ACCOUNT:new t("5eoDkP6vCQBXqDV9YN2NdUs3nmML3dMRNmEYpiyVNBm2"),REGISTER_PROGRAM_ID:new t("snshBoEQ9jx4QoHBpZDQPYdNCtw7RMxJvYrKFEhwaPJ"),REVERSE_LOOKUP_CLASS:new t("7NbD1vprif6apthEZAqhRfYuhrqnuderB8qpnfXGCc8H"),USDC_MINT:new t("4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU"),REFERRERS:[new t("3ogYncmMM5CmytsGCqKHydmXmKUZ6sGWvizkzqwT7zb1")],TOKENS_SYM_MINT:new Map([["4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU","USDC"],["EJwZgeZrdC8TXTQbQBoL6bfuAnFUUy1PVCMB4DYPzVaS","USDT"],["So11111111111111111111111111111111111111112","SOL"],["fidaWCioBQjieRrUQDxxS5Uxmq1CLi2VuVRyv4dEBey","FIDA"],["DL4ivZm3NVHWk9ZvtcqTchxoKArDK4rT3vbDx2gYVr7P","INJ"]]),PYTH_FEEDS:new Map([["4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU",{price:"5SSkXsEKQepHHAewytPVwdej4epN1nxgLVM84L4KXgy7",product:"6NpdXrQEpmDZ3jZKmM2rhdmkd3H6QAk23j2x8bkXcHKA"}],["EJwZgeZrdC8TXTQbQBoL6bfuAnFUUy1PVCMB4DYPzVaS",{price:"38xoQ4oeJCBrcVvca2cGk7iV1dAfrmTR1kmhSCJQ8Jto",product:"C5wDxND9E61RZ1wZhaSTWkoA8udumaHnoQY6BBsiaVpn"}],["So11111111111111111111111111111111111111112",{price:"J83w4HKfqxwcq3BEMMkPFSppX3gqekLyLJBexebFVkix",product:"3Mnn2fX6rQyUsyELYms1sBJyChWofzSNRoqYzvgMVz5E"}],["EchesyfXePKdLtoiZSL8pBe8Myagyy8ZRqsACNCFGnvp",{price:"7teETxN9Y8VK6uJxsctHEwST75mKLLwPH1jaFdvTQCpD",product:"5kWV4bhHeZANzg5MWaYCQYEEKHjur5uz1mu5vuLHwiLB"}],["DL4ivZm3NVHWk9ZvtcqTchxoKArDK4rT3vbDx2gYVr7P",{price:"44uRsNnT35kjkscSu59MxRr9CfkLZWf6gny8bWqUbVxE",product:"7UHB783Nh4avW3Yw9yoktf2KjxipU56KPahA51RnCCYE"}]]),PYTH_MAPPING_ACC:new t("BmA9Z6FjioHJPpjT39QazZyhDRUdZy2ezwx4GiDdE2u2"),VAULT_OWNER:new t("SNSaTJbEv2iT3CUrCQYa9zpGjbBVWhFCPaSJHkaJX34")},Ea=(e,r,n)=>{const i=[e];r?i.push(r.toBuffer()):i.push(s.Buffer.alloc(32)),n?i.push(n.toBuffer()):i.push(s.Buffer.alloc(32));const[o]=t.findProgramAddressSync(i,va.NAME_PROGRAM_ID);return o},Aa=(t,e=va.ROOT_DOMAIN_ACCOUNT,r)=>{let n=Dn(t);return{pubkey:Ea(n,r,e),hashed:n}},Ba=t=>{t.endsWith(".sol")&&(t=t.slice(0,-4));const e=t.split(".");if(2===e.length){const t="\0".concat(e[0]),{pubkey:r}=Aa(e[1]);return{...Aa(t,r),isSub:!0,parent:r}}if(e.length>=3)throw new Pt(Lt.InvalidInput);return{...Aa(t,va.ROOT_DOMAIN_ACCOUNT),isSub:!1,parent:void 0}},Ia=(t,e)=>{const{pubkey:r,parent:n}=Ba(t),i=Dn(r.toBase58());return Ea(i,va.REVERSE_LOOKUP_CLASS,e?n:void 0)};async function Sa(t,r,n,i,o,s,a,u){const c=await ar(r),f=await Ea(c,a,u),h=s||await t.getMinimumBalanceForRentExemption(n);let d;if(u){const{registry:e}=await sr(t,u);d=e.owner}return $t(va.NAME_PROGRAM_ID,e.programId,f,o,i,c,new Ct(h),new Tt(n),a,u,d)}const xa=async(r,i,o,s,a)=>{let[u]=await t.findProgramAddress([va.REGISTER_PROGRAM_ID.toBuffer()],va.REGISTER_PROGRAM_ID),c=await ar(r.toBase58()),f=Ea(c,u,s);return[[],[new ee({name:i}).getInstruction(va.REGISTER_PROGRAM_ID,va.NAME_PROGRAM_ID,va.ROOT_DOMAIN_ACCOUNT,f,e.programId,u,o,n,s,a)]]},Ra={utils:{getNameAccountKeySync:Ea,reverseLookup:async(t,e)=>{const r=Dn(e.toBase58()),n=Ea(r,va.REVERSE_LOOKUP_CLASS),{registry:i}=await be.retrieve(t,n);if(!i.data)throw new Pt(Lt.NoAccountData);return Qn(i.data)},_deriveSync:Aa,getDomainKeySync:Ba,getReverseKeySync:Ia},constants:va,bindings:{createNameRegistry:Sa,updateNameRegistryData:async function(t,e,r,n,i,o){const s=await ar(e),a=Ea(s,i,o);let u;return u=i||(await be.retrieve(t,a)).registry.owner,Kt(va.NAME_PROGRAM_ID,a,new Tt(r),n,u)},transferNameOwnership:async function(t,e,r,n,i,o){const s=await ar(e),a=Ea(s,n,i);let u;return u=n||(await be.retrieve(t,a)).registry.owner,Qt(va.NAME_PROGRAM_ID,a,r,u,n,i,o)},deleteNameRegistry:async function(t,e,r,n,i){const o=await ar(e),s=Ea(o,n,i);let a;return a=n||(await be.retrieve(t,s)).registry.owner,Jt(va.NAME_PROGRAM_ID,s,r,a)},registerDomainName:async(r,i,o,s,a,u=va.USDC_MINT,c)=>{if(i.includes(".")||i.trim().toLowerCase()!==i)throw new Pt(Lt.InvalidDomain);const[f]=t.findProgramAddressSync([va.REGISTER_PROGRAM_ID.toBuffer()],va.REGISTER_PROGRAM_ID),h=Dn(i),d=Ea(h,void 0,va.ROOT_DOMAIN_ACCOUNT),l=Dn(d.toBase58()),p=Ea(l,f),[y]=t.findProgramAddressSync([d.toBuffer()],va.REGISTER_PROGRAM_ID),w=va.REFERRERS.findIndex((t=>null==c?void 0:c.equals(t)));let b;const m=[];if(-1!==w&&c){b=_t(u,c,!0);const t=await r.getAccountInfo(b);if(!(null==t?void 0:t.data)){const t=Ut(s,b,c,u);m.push(t)}}const v=_t(u,va.VAULT_OWNER),E=Ra.constants.PYTH_FEEDS.get(u.toBase58());if(!E)throw new Pt(Lt.PythFeedNotFound);const A=new re({name:i,space:o,referrerIdxOpt:-1!=w?w:null}).getInstruction(va.REGISTER_PROGRAM_ID,va.NAME_PROGRAM_ID,va.ROOT_DOMAIN_ACCOUNT,d,p,e.programId,f,s,a,va.PYTH_MAPPING_ACC,new t(E.product),new t(E.price),v,g,n,y,b);return m.push(A),[[],m]},createReverseName:xa,createSubdomain:async(t,e,r,n=2e3)=>{const i=[],o=e.split(".")[0];if(!o)throw new Pt(Lt.InvalidSubdomain);const{parent:s,pubkey:a}=Ba(e),u=await t.getMinimumBalanceForRentExemption(n+be.HEADER_LEN),c=await Sa(t,"\0".concat(o),n,r,r,u,void 0,s);i.push(c);const f=Ia(e,!0),h=await t.getAccountInfo(f);if(!(null==h?void 0:h.data)){const[,t]=await xa(a,"\0".concat(o),r,s,r);i.push(...t)}return[[],i]},burnDomain:(r,n,i)=>{const{pubkey:o}=Ba(r),[s]=t.findProgramAddressSync([o.toBuffer()],va.REGISTER_PROGRAM_ID),[a]=t.findProgramAddressSync([o.toBuffer(),Uint8Array.from([1,1])],va.REGISTER_PROGRAM_ID);return(new ie).getInstruction(va.REGISTER_PROGRAM_ID,va.NAME_PROGRAM_ID,e.programId,o,Ia(r),a,s,va.REVERSE_LOOKUP_CLASS,n,i)},transferSubdomain:async(t,e,r,n,i)=>{const{pubkey:o,isSub:s,parent:a}=Ba(e);if(!a||!s)throw new Pt(Lt.InvalidSubdomain);if(!i){const{registry:e}=await be.retrieve(t,o);i=e.owner}let u,c;n&&(u=a,c=(await be.retrieve(t,a)).registry.owner);return Qt(va.NAME_PROGRAM_ID,o,r,i,void 0,u,c)},registerDomainNameV2:async(r,i,o,s,a,u=va.USDC_MINT,c)=>{if(i.includes(".")||i.trim().toLowerCase()!==i)throw new Pt(Lt.InvalidDomain);const[f]=t.findProgramAddressSync([va.REGISTER_PROGRAM_ID.toBuffer()],va.REGISTER_PROGRAM_ID),h=Dn(i),d=Ea(h,void 0,va.ROOT_DOMAIN_ACCOUNT),l=Dn(d.toBase58()),p=Ea(l,f),[y]=t.findProgramAddressSync([d.toBuffer()],va.REGISTER_PROGRAM_ID),w=va.REFERRERS.findIndex((t=>null==c?void 0:c.equals(t)));let b;const m=[];if(-1!==w&&c){b=_t(u,c,!0);const t=await r.getAccountInfo(b);if(!(null==t?void 0:t.data)){const t=Ut(s,b,c,u);m.push(t)}}const v=_t(u,va.VAULT_OWNER,!0),E=or.get(u.toBase58());if(!E)throw new Pt(Lt.PythFeedNotFound);const[A]=Jn(0,E),B=new ae({name:i,space:o,referrerIdxOpt:-1!=w?w:null}).getInstruction(va.REGISTER_PROGRAM_ID,va.NAME_PROGRAM_ID,va.ROOT_DOMAIN_ACCOUNT,d,p,e.programId,f,s,s,s,a,A,v,g,n,y,b);return m.push(B),m}}};export{Fe as BONFIDA_FIDA_BNB,Xe as BONFIDA_USDC_BNB,er as CUSTOM_BG_TLD,ha as CustomBg,ir as DEFAULT_PYTH_PUSH_PROGRAM,bs as ETH_ROA_RECORDS,ms as EVM_RECORDS,Lt as ErrorType,_s as FavouriteDomain,ws as GUARDIANS,We as HASH_PREFIX,nr as METAPLEX_ID,ks as NAME_OFFERS_ID,De as NAME_PROGRAM_ID,be as NameRegistryState,Tt as Numberu32,Ct as Numberu64,Ke as PYTH_FEEDS,je as PYTH_FIDA_PRICE_ACC,Qe as PYTH_MAPPING_ACC,or as PYTH_PULL_FEEDS,Fr as RECORD_V1_SIZE,Ze as REFERRERS,ze as REGISTER_PROGRAM_ID,Ve as REVERSE_LOOKUP_CLASS,Me as ROOT_DOMAIN_ACCOUNT,jr as Record,Vr as RecordVersion,ca as ReverseTwitterRegistryState,As as SELF_SIGNED,Pt as SNSError,qe as SOL_RECORD_SIG_LEN,$e as TOKENS_SYM_MINT,Ge as TWITTER_ROOT_PARENT_REGISTRY_KEY,He as TWITTER_VERIFICATION_AUTHORITY,Ye as USDC_MINT,Es as UTF8_ENCODED,tr as VAULT_OWNER,Je as VAULT_OWNER_DEPRECATED,rr as WOLVES_COLLECTION_METADATA,$s as burnDomain,ie as burnInstruction,ea as changeTwitterRegistryData,ra as changeVerifiedPubkey,Zn as check,Vo as checkSolRecord,$t as createInstruction,re as createInstructionV3,Ps as createNameRegistry,zs as createRecordInstruction,js as createRecordV2Instruction,ee as createReverseInstruction,Ws as createReverseName,fa as createReverseTwitterRegistry,Ys as createSolRecordInstruction,ae as createSplitV2Instruction,Ms as createSubdomain,te as createV2Instruction,ta as createVerifiedTwitterRegistry,ne as createWithNftInstruction,Jt as deleteInstruction,Os as deleteNameRegistry,Hs as deleteRecordV2,na as deleteTwitterRegistry,ps as deserializeRecord,Bs as deserializeRecordV2Content,Qn as deserializeReverse,Ra as devnet,Xs as ethValidateRecordV2Content,jn as findSubdomains,Hn as getAllDomains,qn as getAllRegisteredDomains,ba as getArtistPubkey,Yo as getArweaveRecord,ls as getBackgroundRecord,ds as getBackpackRecord,fs as getBscRecord,$o as getBtcRecord,wa as getCustomBgKeys,es as getDiscordRecord,Qo as getDogeRecord,dr as getDomainKey,Vn as getDomainKeySync,Gn as getDomainKeysWithReverses,fe as getDomainMint,Kn as getDomainPriceFromName,Jo as getEmailRecord,Zo as getEthRecord,Us as getFavoriteDomain,rs as getGithubRecord,sa as getHandleAndRegistryKey,ar as getHashedName,Dn as getHashedNameSync,hs as getInjectiveRecord,Xo as getIpfsRecord,Ko as getLtcRecord,Ls as getMultipleFavoriteDomains,Rs as getMultipleRecordsV2,ur as getNameAccountKey,Wn as getNameAccountKeySync,sr as getNameOwner,ss as getPicRecord,cs as getPointRecord,Jn as getPythFeedAccountKey,Go as getRecord,Ho as getRecordKeySync,xs as getRecordV2,Ss as getRecordV2Key,qo as getRecords,ns as getRedditRecord,lr as getReverseKey,Yn as getReverseKeyFromDomainKey,Xn as getReverseKeySync,as as getShdwRecord,us as getSolRecord,os as getTelegramRecord,$n as getTokenizedDomains,aa as getTwitterHandleandRegistryKeyViaFilters,is as getTwitterRecord,oa as getTwitterRegistry,ua as getTwitterRegistryData,ia as getTwitterRegistryKey,ts as getUrlRecord,cr as performReverseLookup,fr as performReverseLookupBatch,oe as reallocInstruction,Ns as registerDomainName,Ds as registerDomainNameV2,Js as registerFavorite,se as registerFavoriteInstruction,Ks as registerWithNft,da as resolve,la as resolveSolRecordV1,pa as resolveSolRecordV2,le as retrieveNftOwner,pe as retrieveNfts,we as retrieveRecords,Mn as reverseLookup,zn as reverseLookupBatch,ys as serializeRecord,Is as serializeRecordV2Content,gs as serializeSolRecord,Qt as transferInstruction,Cs as transferNameOwnership,Qs as transferSubdomain,Kt as updateInstruction,Ts as updateNameRegistryData,Fs as updateRecordInstruction,Vs as updateRecordV2Instruction,Zs as updateSolRecordInstruction,Gs as validateRecordV2Content,vs as verifyRightOfAssociation,ma as verifyStaleness,qs as writRoaRecordV2};
